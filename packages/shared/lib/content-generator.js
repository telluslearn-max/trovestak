...
// ============================================
export function generateFeatures(productName, brand, category, subcategory) {
...
export function generateFAQ(productName, brand, category) {
...
export function generateDefaultFAQ(brand) {
    return [
        {
