...
export function generateSpecs(productName, category, subcategory) {
...
function generateMobileSpecs(productName) {
    const lowerName = productName.toLowerCase();
    const specs = {
        'Display': {
            'Type': 'OLED / AMOLED',
...
function generateLaptopSpecs(productName) {
    const lowerName = productName.toLowerCase();
    const specs = {
        'Display': {
            'Size': '13" - 16"',
...
function generateTabletSpecs(productName) {
    const lowerName = productName.toLowerCase();
    const specs = {
        'Display': {
            'Size': '8.3" - 13"',
...
function generateEarbudSpecs(productName) {
    const lowerName = productName.toLowerCase();
    const specs = {
        'Audio': {
...
function generateHeadphoneSpecs(productName) {
    const lowerName = productName.toLowerCase();
    const specs = {
        'Audio': {
            'Driver': '30mm - 40mm',
...
function generateSpeakerSpecs(productName) {
    const lowerName = productName.toLowerCase();
    const specs = {
        'Audio': {
            'Driver': 'Custom',
...
function generateWatchSpecs(productName) {
    const lowerName = productName.toLowerCase();
    const specs = {
        'Display': {
            'Size': '40mm - 49mm',
...
function generateGamingSpecs(productName) {
    const lowerName = productName.toLowerCase();
    const specs = {
        'Performance': {
...
function generateNetworkingSpecs(productName) {
    const specs = {
        'Performance': {
            'Speed': 'Up to 10Gbps',
            'Ports': '24 - 48 ports',
...
function generatePrinterSpecs(productName) {
    const specs = {
        'Print': {
            'Type': 'Laser / Inkjet',
            'Speed': '20 - 40 ppm',
...
export function getAddonEligibility(price, category, subcategory) {
